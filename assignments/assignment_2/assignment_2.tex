...
\noindent By the end of this problem, you should have a solid understanding of
 ...
 \vspace{4pt}
 \noindent \textbf{Problem \#1a: The nuclear timescale ($\tau_{\rm{nuc}}$)}
 ...
 a function of the mass of the star only.
 ...
 \vspace{10pt}
 \noindent \textbf{Problem \#1b: The thermal timescale ($\tau_{\rm{therm}}$)}
 ...
 \vspace{10pt}
 \noindent \textbf{Problem \#1c: The dynamical timescale ($\tau_{\rm{dyn}}$)}
 ...
 as a function of the mass of the star only.
 ...
 \vspace{10pt}
 \noindent \textbf{Problem \#1d: Comparing the timescales}
 ...
 $\tau_{\rm{dyn}}$ and $\tau_{\rm{therm}}$ for such a red giant.
...
\newpage
 ...
 manuscripts as part of astronomy research}}
 ...
 \vspace{10pt}
 \noindent \textbf{Problem \#2a: The ads search form}\\
 ...
 \vspace{10pt}
 \noindent \textbf{Problem \#2b: Narrowing down a search}\\
 ...
 \vspace{10pt}
 \noindent \textbf{Problem \#2c: Selecting papers to read}\\
 ...
 options and pick one paper from each option. Which was the easiest option for
 selection? Why? (Note there isn't a right answer but you should be able to
 articulate which one you prefer since it will help you in future literature
 searches!) 
